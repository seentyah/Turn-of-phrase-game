...
class GamePlay extends Component {
    ...
    nextBtn() {
        ...
        else{alert('Oh No, Give it another try');}
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <img src={this.state.prompts[this.state.number].image} width="700" height="300" alt="sad." />
                <div className="trythis" id="input" rows="2" name="charcount">
                {this.state.prompts[this.state.number].tiles}</div>
                <div className="keyboard" id="letterBank">
                    ...
                    <Button disabled={!this.state.disabled} onClick={() => { this.enterLetters('_') }}>space</Button>
                </div>
                ...
                <Modal isOpen={this.state.isCorrectOpen} toggle={this.toggleCorrect}>
                    ...
                    <ModalFooter>
                        ...
                        <Button onClick={this.resetButton}>Quit</Button>
                    </ModalFooter>
                </Modal>
