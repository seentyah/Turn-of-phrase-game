    ...
    return (
        ...
        <CardBody>
          ...
          <Col  lg="6" className="mb-lg-0 mb-5">
                ...
                <img src="../assets/cyn.png" width="200" height="200" className="rounded-circle z-depth-1 img-fluid"
                alt="Cynthia" />
              ...
              <Col  lg="6" className="mb-lg-0 mb-5">
                    ...
                    <img src="../assets/circle-will.png" width="200" height="200" className="rounded-circle z-depth-1 img-fluid"
                alt="Will" />
